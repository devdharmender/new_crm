...
<body>
    ...
    <form action="<?= base_url('form_sub_off/create'); ?>" method="post" enctype="multipart/form-data">
        <!-- Top Head section -->
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex flex-column align-items-start">
                                <div class="row py-2 px-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-row align-items-center" for="city2">
                                            <input type="radio" name="city-radio" id="city2" value="Noida" <?php echo set_radio('city-radio', 'Noida'); ?>>
                                            <h6 class="city-name d-flex align-items-center">&nbsp;Noida</h6>
                                        </div>
                                    </div>
                                    </div><div class="col-md-6">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-row align-items-center" for="city2">
                                            <input type="radio" name="city-radio" id="city2" value="GreaterNoida" <?php echo set_radio('city-radio', 'GreaterNoida'); ?>>
                                            <h6 class="city-name d-flex align-items-center">&nbsp;GreaterNoida</h6>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-row align-items-center" for="city2">
                                            <input type="radio" name="city-radio" id="city2" value="Faridabad" <?php echo set_radio('city-radio', 'Faridabad'); ?>>
                                            <h6 class="city-name d-flex align-items-center">&nbsp;Faridabad</h6>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-row align-items-center" for="city2">
                                            <input type="radio" name="city-radio" id="city2" value="Ghaziabad" <?php echo set_radio('city-radio', 'Ghaziabad'); ?>>
                                            <h6 class="city-name d-flex align-items-center">&nbsp;Ghaziabad</h6>
                                        </div>
                                    </div>
                                    </div>
                                </div>
            ...
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-sm-12 col-md-6 my-1 d-flex flex-row">
                        <span class="details-feild d-flex align-items-center">Date<span style="color: red;font-size: large;">*</span>&nbsp;:&nbsp;</span><span class="details-feild d-flex align-items-center" id="span"> </span>
                        <input class="form-control" type="text" name="date" id="date" placeholder="" value="" style="display:none;">
                    </div>
                    <div class="col-sm-12 col-md-6 my-1 d-flex flex-row">
 ...
 <!--check list-->
        ...
        <section class="laptop-image">
            <div class="container-fluid ">
                <div class="row ">
                    ...
                    <!--        Other View <br/>-->
                    <!--        <i class="fa fa-2x fa-camera"></i>-->
                    <!--        <input id="inputTag7" type="file" name="file_input[]" multiple="multiple" style="margin-top: 20px;"/>-->
                    <!--        <br/>-->
                    <!--        <span id="imageName"></span>-->
                    <!--    </label>-->
                    <!--</div>-->
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 my-1 d-flex flex-row">
                <span class="details-feild d-flex align-items-center">Submited&nbsp;By&nbsp;<span style="color: red;font-size: large;">*</span>&nbsp;:&nbsp;</span><input type="radio" name="pick-radio" value="Visit" id="Visit" <?php echo set_radio('pick-radio', 'Visit'); ?> checked>
                <h6 class="city-name d-flex align-items-center">&nbsp;Visit&nbsp;&nbsp;</h6>&nbsp;<input type="radio" name="pick-radio" id="Pickup" value="Pickup" <?php echo set_radio('pick-radio', 'Pickup'); ?>>
                <h6 class="city-name d-flex align-items-center">&nbsp;Pickup</h6>
            </div><br>
        </div>
        <!-- Horizental line -->
        <hr class="h-line">
