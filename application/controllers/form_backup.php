...
// insert data in database
    ...
    // don' delete this----------
        ...
        if($a){
            ...
            <body>
            <div><img src="https://www.lappymaker.com/images/lappy-maker-logo.png" alt="Lappy Maker Logo" width="250px" />
            <h1>Laptop Door services</h1>
        <p style="text-align:center;">Thankyou for choosing lappy maker services your laptop and OTP details given below:</p>
        </div>
        ...
        <table class="table">
            <tbody>
                    ...
                    <td>
                        <section class="parts-picked px-2">
                            ...
                            <div class="row">
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="keyboard" value="Keyboard" id="city1" checked="'.$checkbox1.'" disabled>
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="camera" value="Camera" id="city1" checked="'.$checkbox3.'" disabled>

                                    <span class="part-name d-flex align-items-center">&nbsp;Camera</span>
                                </div>
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="wi_fi" value="WI-FI" id="city1" checked="'.$checkbox4.'" disabled>

                                    <span class="part-name d-flex align-items-center">&nbsp;WI-FI</span>
                                </div>
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="display" value="Display" id="city1" checked="'.$checkbox5.'" disabled>
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="touchpad_clicks" value="Touchpad Clicks"
                                        id="city1" checked="'.$checkbox7.'" disabled>

                                    <span class="part-name d-flex align-items-center">&nbsp;Touchpad Clicks</span>
                                </div>
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="sound" value="Sound" id="city1" checked="'.$checkbox8.'" disabled>
                            ...
                            <td>
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="battery_backup" value="Battery Backup"
                                        id="city1" checked="'.$checkbox14.'" disabled>
                    ...
                    <td>
                        <section class="parts-picked px-2">
                            ...
                            <div class="row">
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="usb_port" value="USB Port" id="city1" checked="'.$checkbox19.'" disabled>
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="mic" value="Mic" id="city1" checked="'.$checkbox22.'" disabled>
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="restart" value="Restart" id="city1" checked="'.$checkbox25.'" disabled>
                    ...
                    <td>
                        <section class="parts-picked px-2">
                            ...
                            <div class="row">
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="camera1" value="Camera" id="city1" checked="'.$ccheckbox3.'" disabled>

                                    <span class="part-name d-flex align-items-center">&nbsp;Camera</span>
                                </div>
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="wi_fi1" value="WI-FI" id="city1" checked="'.$ccheckbox4.'" disabled>

                                    <span class="part-name d-flex align-items-center">&nbsp;WI-FI</span>
                                </div>
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="display1" value="Display" id="city1" checked="'.$ccheckbox5.'" disabled>
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="touchpad_clicks1" value="Touchpad Clicks"
                                        id="city1" checked="'.$ccheckbox7.'" disabled>

                                    <span class="part-name d-flex align-items-center">&nbsp;Touchpad Clicks</span>
                                </div>
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="sound1" value="Sound" id="city1" checked="'.$ccheckbox8.'" disabled>
                            ...
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="safari_chrome1" value="Safari/Chrome"
                                        id="city1" checked="'.$ccheckbox9.'" disabled>
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="battery_backup1" value="Battery Backup"
                                        id="city1" checked="'.$ccheckbox14.'" disabled>
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="charging_port1" value="Charging/Port"
                                        id="city1" checked="'.$ccheckbox15.'" disabled>
                            ...
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="internal_sno1" value="Internal S.No"
                                        id="city1" checked="'.$ccheckbox18.'" disabled>
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="mic1" value="Mic" id="city1" checked="'.$ccheckbox22.'" disabled>
                                ...
                                <div
                                    class="col-6  ">
                                    <input type="checkbox" name="restart1" value="Restart" id="city1" checked="'.$ccheckbox25.'" disabled>
                ...
                <tr>
                    ...
                    <td> 
                        <img src="https://www.lappymaker.co/diagonis/assets/uploads_img/laptop_img/a5fcf6fff8091ceec46c31b0b638db05.jpg" alt="Physical Condition img" stryle="width:400px;height:auto" />
                    </td>
                ...
                style="font-size:15px;font-weight:bold;text-align:center;">NO DATA GUARANTEE</span></td>
           ...
           <body>
             ...
             <tr >
               <div><img  src="https://www.lappymaker.com/images/lappy-maker-logo.png" alt="Lappy Maker Logo"   width="250px"/></div>
                    ...
                    <tr >
                      <h1>Laptop Door services</h1>
                      <p>Dear ' . $name . '</p>
                      <p>Thankyou for choosing lappy maker services your laptop and OTP details given below: </p>
                   </tr>
             <tr >
              <td ><b> Ticket No : LM </b>' . $last_ticket . '</td>
            </tr>
            <tr >
              <td ><b> Date :  </b>' . $date . '</td>
            </tr>
            ...
            <tr >
             ...
             <tr >
              <td ><b> Your Final Amount :  </b>' . $finalamount . '</td>
            </tr>
            
            <tr >
              <td ><b> Reported Problem By customer   :  </b>' . $reported_problems_cust . '</td>
            </tr>
             <tr >
              <td ><b> Solution Provided By Executive  :  </b>' . $sol_given . '</td>
            </tr>
                    ...
                    <section class="parts-picked px-2">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="keyboard" value="Keyboard" id="city1" '.$checkbox1.' disabled>
                                <span class="part-name d-flex align-items-center">&nbsp;Keyboard</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touoch_pad1" value="Touch Pad" id="city1" '.$checkbox2.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch Pad</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="camera" value="Camera" id="city1" '.$checkbox3.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Camera</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="wi_fi" value="WI-FI" id="city1" '.$checkbox4.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;WI-FI</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="display" value="Display" id="city1" '.$checkbox5.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Display</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="ms_office" value="MS Office" id="city1" '.$checkbox6.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;MS Office</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touchpad_clicks" value="Touchpad Clicks" id="city1" '.$checkbox7.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touchpad Clicks</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="sound" value="Sound" id="city1" '.$checkbox8.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Sound</span>
                            </div>
            
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="safari_chrome" value="Safari/Chrome" id="city1" '.$checkbox9.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Safari/Chrome</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touch_screen" value="Touch Screen" id="city1" '.$checkbox10.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch Screen</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touch_id" value="Touch ID/Face ID" id="city1" '.$checkbox11.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch ID/Face ID</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touch_bar" value="Touch Bar" id="city1" '.$checkbox12.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch&nbsp;Bar</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="battery_h" value="Battery H" id="city1" '.$checkbox13.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Battery H.</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="battery_backup" value="Battery Backup" id="city1" '.$checkbox14.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Battery Backup</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="charging_port" value="Charging/Port" id="city1" '.$checkbox15.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Charging/Port</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="bluetooth" value="Bluetooth" id="city1" '.$checkbox16.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Bluetooth</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="back_light" value="Back Light" id="city1" '.$checkbox17.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Back Light</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="internal_sno" value="Internal S.No" id="city1" '.$checkbox18.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Internal S.No</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="usb_port" value="USB Port" id="city1" '.$checkbox19.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;USB Port</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="audio_port" value="Audio Port" id="city1" '.$checkbox20.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Audio Port</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="sleep_mode" value="Sleep Mode" id="city1" '.$checkbox21.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Sleep Mode</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="mic" value="Mic" id="city1"  '.$checkbox22.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Mic</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="shut_down" value="Shut Down" id="city1" '.$checkbox23.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Shut Down</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="downloads" value="Downloads" id="city1" '.$checkbox24.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Downloads</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="restart" value="Restart" id="city1" '.$checkbox25.' disabled>
            ...
            <tr >
                <td >
                    <section class="parts-picked px-2">
                        <p class="parts-picked-heading text-center">Check&nbsp;List&nbsp; ~ After Part Installation</p>
                        <hr style="color:#fff;">
                        <div class="row">
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="keyboard1" value="Keyboard" id="city1" '.$ccheckbox1.' disabled>
                                <span class="part-name d-flex align-items-center">&nbsp;Keyboard</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touoch_pad1" value="Touch Pad" id="city1" '.$ccheckbox2.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch Pad</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="camera1" value="Camera" id="city1" '.$ccheckbox3.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Camera</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="wi_fi1" value="WI-FI" id="city1" '.$ccheckbox4.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;WI-FI</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="display1" value="Display" id="city1" '.$ccheckbox5.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Display</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="ms_office1" value="MS Office" id="city1" '.$ccheckbox6.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;MS Office</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touchpad_clicks1" value="Touchpad Clicks" id="city1" '.$ccheckbox7.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touchpad Clicks</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="sound1" value="Sound" id="city1" '.$ccheckbox8.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Sound</span>
                            </div>
            
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="safari_chrome1" value="Safari/Chrome" id="city1" '.$ccheckbox9.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Safari/Chrome</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touch_screen1" value="Touch Screen" id="city1" '.$ccheckbox10.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch Screen</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touch_id1" value="Touch ID/Face ID" id="city1" '.$ccheckbox11.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch ID/Face ID</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="touch_bar1" value="Touch Bar" id="city1" '.$ccheckbox12.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Touch&nbsp;Bar</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="battery_h1" value="Battery H" id="city1" '.$ccheckbox13.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Battery H.</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="battery_backup1" value="Battery Backup" id="city1" '.$ccheckbox14.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Battery Backup</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="charging_port1" value="Charging/Port" id="city1" '.$ccheckbox15.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Charging/Port</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="bluetooth1" value="Bluetooth" id="city1" '.$ccheckbox16.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Bluetooth</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="back_light1" value="Back Light" id="city1" '.$ccheckbox17.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Back Light</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="internal_sno1" value="Internal S.No" id="city1" '.$ccheckbox18.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Internal S.No</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="usb_port1" value="USB Port" id="city1" '.$ccheckbox19.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;USB Port</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="audio_port1" value="Audio Port" id="city1" '.$ccheckbox20.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Audio Port</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="sleep_mode1" value="Sleep Mode" id="city1" '.$ccheckbox21.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Sleep Mode</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="mic1" value="Mic" id="city1"  '.$ccheckbox22.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Mic</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="shut_down1" value="Shut Down" id="city1" '.$ccheckbox23.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Shut Down</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="downloads1" value="Downloads" id="city1" '.$ccheckbox24.' disabled>

                                <span class="part-name d-flex align-items-center">&nbsp;Downloads</span>
                            </div>
                            <div class="col-6 col-md-6 col-lg-4 d-flex radioalign-items-center justify-content-start flex-row">
                                <input type="checkbox" name="restart1" value="Restart" id="city1" '.$ccheckbox25.' disabled>
              ...
              <tr >
              <td ><b> Executive Name :  </b>' . $executive_name . '</td>
            </tr>
            <tr >
                 <td ><b>Physical Condition : </b><br><img  src="https://www.lappymaker.co/diagonis/assets/uploads_img/home_door/' . $img_name . '" alt="Physical Condition img" stryle="width:400px;height:auto"/></td>
                </tr>
                     <tr >
                 <td ><b>Physical Condition2 : </b><br><img  src="https://www.lappymaker.co/diagonis/assets/uploads_img/home_door/' . $img_name2 . '" alt="Physical Condition img" stryle="width:400px;height:auto"/></td>
                </tr>
                  <tr >
                 <td ><b>Physical Condition3 : </b><br><img  src="https://www.lappymaker.co/diagonis/assets/uploads_img/home_door/' . $img_name3 . '" alt="Physical Condition img" stryle="width:400px;height:auto"/></td>
                </tr>
                  <tr >
                 <td ><b>Physical Condition4 : </b><br><img  src="https://www.lappymaker.co/diagonis/assets/uploads_img/home_door/' . $img_name4 . '"  alt="Physical Condition img" stryle="width:400px;height:auto"/></td>
            </tr>
            
            <tr >
                <td ><b> Note :  </b> 
                    <p style="text-align:justify;">I hereby confirm the above-mentioned part that has been installed or serviced by the Lappy Maker Engineer, I am fully satisfied with installation process and with the quality of the service provided. I affirm that my laptop is functioning properly following the service or part installation, and there has been no negative impact on any other part of device during the repair or replacement process. <br> <span style="font-size:15px;font-weight:bold;text-align:center;">NO DATA GUARANTEE</span>
                    </p>
                </td>
            </tr>
            <tr >
            ...
            <tr > <td> <b>Write Your Exprince :</b> https://g.page/r/Ca8qienVSuH_EBM/review</td> </tr>
            </table></body></html>';
